...
Use an h1 tag for the site title and an h2for the subtitle inside the page header.
...
Give the bodya max-widthof 1000px and center it on the page with the margin auto technique.
